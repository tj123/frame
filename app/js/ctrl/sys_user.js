(function (angular, $, app) {
  ...
  app.controller('SysUserAddCtrl', ['$scope', '$http', '$state', '$stateParams','$timeout', function ($scope, $http, $state, $stateParams,$timeout) {

    var user = $scope.user = {};

    $scope.depLoad = function () {


      console.log('dep load');
    ...
    $(function () {
      ...
      setTimeout(function () {
        $('#department').chosen().change(function (dt) {
          console.log(dt);
        });
