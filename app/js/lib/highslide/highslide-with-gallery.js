...
// Language strings
    lang: {
      ...
      resizeTitle: '改变大小',
      playText: '播放',
      playTitle: '幻灯播放 (spacebar)',
      pauseText: '停止',
      pauseTitle: '停止播放 (spacebar)',
      previousTitle: '上一张',
      nextTitle: '下一张',
      moveTitle: '移动',
      fullExpandText: '1:1',
      number: '图片 %1 / %2',
      restoreTitle: '点击关闭图片，可拖动改变位置，使用键盘翻页。'
    },
// See http://highslide.com/ref for examples of settings
//graphicsDir : 'js/lib/highslide/graphics/',
    graphicsDir: 'js/lib/highslide/graphics/',
